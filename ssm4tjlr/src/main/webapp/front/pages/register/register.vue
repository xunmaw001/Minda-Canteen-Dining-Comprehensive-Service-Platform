	...
	<view class="content">
		...
		<view v-if="tableName=='yonghu'" class="uni-form-item uni-column">
                        <picker @change="yonghushenfenleixingChange" :value="yonghushenfenleixingIndex" :range="yonghushenfenleixingOptions">
                                <view :style='{"borderColor":"#ccc","backgroundColor":"#fff","borderRadius":"16rpx","color":"#333","textAlign":"left","borderWidth":"4rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx"}' class="uni-input">{{ruleForm.shenfenleixing?ruleForm.shenfenleixing:"请选择身份类型"}}</view>
                        </picker>
                </view>
		...
		<view v-if="tableName=='shangjia'" class="uni-form-item uni-column">
			<input :style='{"borderColor":"#ccc","backgroundColor":"#fff","borderRadius":"16rpx","color":"#333","textAlign":"left","borderWidth":"4rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx"}' v-model="ruleForm.shangjiamingcheng" type="text" class="uni-input" name="" placeholder="商家名称" />
		</view>
		<view v-if="tableName=='shangjia'" class="uni-form-item uni-column">
			<input :style='{"borderColor":"#ccc","backgroundColor":"#fff","borderRadius":"16rpx","color":"#333","textAlign":"left","borderWidth":"4rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx"}' v-model="ruleForm.jingyingfanwei" type="text" class="uni-input" name="" placeholder="经营范围" />
		</view>
		<view v-if="tableName=='shangjia'" class="uni-form-item uni-column">
	...
	export default {
		...
		async onLoad() {
			...
			if(this.tableName=='yonghu'){
				...
				this.ruleForm.shenfenleixing=this.yonghushenfenleixingOptions[0]
			}
