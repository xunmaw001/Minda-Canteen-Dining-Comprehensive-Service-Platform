	...
	export default {
		...
		async onLoad(options) {
			...
			if (options.id) {
				...
				// 获取信息
				res = await this.$api.info(`discussshangjiacanpin`, this.ruleForm.id);
		...
		methods: {
			...
			async onSubmitTap() {
					...
					return
																																																																												...
																																																																												if(this.ruleForm.id){
					await this.$api.update(`discussshangjiacanpin`, this.ruleForm);
				}else{
					await this.$api.add(`discussshangjiacanpin`, this.ruleForm);
				}
