<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="档口号" prop="dangkouhao">
          <el-input v-model="ruleForm.dangkouhao" 
              placeholder="档口号" clearable  :readonly="ro.dangkouhao"></el-input>
        </el-form-item>
        <div v-else>
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="餐品种类" prop="canpinzhonglei">
          <el-input v-model="ruleForm.canpinzhonglei" 
              placeholder="餐品种类" clearable  :readonly="ro.canpinzhonglei"></el-input>
        </el-form-item>
        <div v-else>
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="结算时间" prop="jiesuanshijian">
            <el-date-picker
                value-format="yyyy-MM-dd HH:mm:ss"
                v-model="ruleForm.jiesuanshijian" 
                type="datetime"
                placeholder="结算时间">
            </el-date-picker>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.jiesuanshijian" label="结算时间" prop="jiesuanshijian">
              <el-input v-model="ruleForm.jiesuanshijian" 
                placeholder="结算时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  created() {
	...
	this.ruleForm.jiesuanshijian = this.getCurDateTime()
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.xiadanshijian = true;
          ...
          if(o=='jiesuanshijian'){
            this.ruleForm.jiesuanshijian = obj[o];
	    this.ro.jiesuanshijian = true;
            continue;
          }
          if(o=='yonghuming'){
