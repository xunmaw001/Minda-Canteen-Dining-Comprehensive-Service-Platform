<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info' && !ro.shangputupian" label="商铺图片" prop="shangputupian">
          <file-upload
          tip="点击上传商铺图片"
          action="file/upload"
          :limit="3"
          ...
          @change="shangputupianUploadChange"
          ></file-upload>
        </el-form-item>
        <div v-else>
          <el-form-item v-if="ruleForm.shangputupian" label="商铺图片" prop="shangputupian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.shangputupian.split(',')" :src="item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  methods: {
	...
	this.ruleForm.shangjiajieshao = this.ruleForm.shangjiajieshao.replace(reg,'../../../ssm4tjlr/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    shangputupianUploadChange(fileUrls) {
